...
import { getAllAdmins } from '../redux/actions/admins';
...
const Admin = () => {
  ...
  useEffect(() => {
    dispatch(getAllAdmins.getAllAdminsRequest());
  }, [dispatch]);
  ...
  const columns = [
    { field: 'name', headerName: 'Họ và tên', minWidth: 180, flex: 1 },
    { field: 'age', headerName: 'Tuổi', minWidth: 250, flex: 1 },
    {
      field: 'image',
      headerName: 'Ảnh',
      width: 75,
